...
namespace utils {
    ...
    static inline void
    SplitData(const std::string &str, const std::string &delimiter, std::vector<std::string> &vec_data) {
        std::string s = str;
        size_t pos = 0;
        std::string token;
    ...
    ReplaceString(const std::string &str, const std::string &flag, const std::string &replaceFlag) {
    ...
    static inline std::string
    JoinSetByDelimiter(const std::set<std::string> &set_string, const std::string &delimiter) {
        std::string str;
    ...
    static inline bool
    code_convert(const char *from, const char *to, const char *instr, size_t inlen, char *outstr, size_t outlen) {
        char **in = (char **) &instr;
        char **out = &outstr;
        iconv_t cd;
